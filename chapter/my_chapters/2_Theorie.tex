    ...
    \label{subsec:system_of_face_recognition}
        ...
        \label{subsubsec:Elastic_bunch_graph_Matching}
            ...
            \label{subsubsubsec:Graphs}
                ...
                $$S_{BG}(G^I,G^B) := \frac{1}{|V|}\sum_{i \in V} \max\limits_{m \in G}S_v(J_i^I, J_{i,m}^B) + \frac{\lambda}{|E|}\sum_{(i,j) \in E}S_e \left(\vec{\Delta}_{ij,m}^I\,, \vec{\Delta}_{ij,m}^B\right) \,.
